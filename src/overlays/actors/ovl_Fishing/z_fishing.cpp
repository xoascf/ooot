                ...
                if (sLurePos.y <= spE4) {
                    ...
                    if ((sLurePos.y <= spE4) && (spE4 < spE0) && (spE4 == WATER_SURFACE_Y(globalCtx))) {
                        ...
                        for (i = 0; i < 50; i++) {
                            ...
                            spA8.z += (sp9C.z * 3.0f);
                            Fishing_SpawnDustSplash(NULL, (FishingEffect*)globalCtx->specialEffects, &spA8, &sp9C,
...
s32 func_80B70A2C(Fishing* pthis, GlobalContext* globalCtx, u8 ignorePosCheck) {
    ...
    for (i = 0; i < count; i++) {
        ...
        Fishing_SpawnDustSplash(&pthis->actor.projectedPos, (FishingEffect*)globalCtx->specialEffects, &pos, &vel,
...
void func_80B70ED4(Fishing* pthis, Input* input) {
    ...
    if ((D_80B7E0B6 != 2) && (D_80B7E114 != 0) && (pthis->unk_1AC > 60.0f) && (sp24 < SQ(30.0f)) &&
        (pthis->unk_158 >= 10)) {
        pthis->unk_15A = 0;
        pthis->unk_158 = 1;
        pthis->unk_1A4 = 1000;
...
void Fishing_UpdateFish(Actor* thisx, GlobalContext* globalCtx2) {
    ...
    switch (pthis->unk_158) {
        case 100:
            ...
            Lights_PointNoGlowSetInfo(&pthis->lightInfo, (s16)pthis->actor.world.pos.x,
                                      (s16)pthis->actor.world.pos.y + 20.0f, (s16)pthis->actor.world.pos.z - 50.0f, 255,
                                      255, 255, 255);
            ...
            if ((pthis->actor.xzDistToPlayer < (250.0f * sp118)) || (pthis->unk_17A[1] != 0)) {
                ...
                if (pthis->actor.world.pos.y < (WATER_SURFACE_Y(globalCtx) - 20.0f)) {
                    ...
                    if ((pthis->actor.speedXZ == 0.0f) ||
                        (pthis->actor.world.pos.y > (WATER_SURFACE_Y(globalCtx) - 5.0f))) {
                        ...
                        Fishing_SpawnRipple(&pthis->actor.projectedPos, (FishingEffect*)globalCtx->specialEffects, &spB8, 10.0f, 300.0f,
                                            150, 90);
                        Fishing_SpawnRipple(&pthis->actor.projectedPos, (FishingEffect*)globalCtx->specialEffects, &spB8, 30.0f, 400.0f,
                                            150, 90);
        ...
        case 2:
            ...
            if ((D_80B7E0B6 != 2) && (pthis->unk_1B4.y < pthis->actor.world.pos.y)) {
                Math_ApproachF(&pthis->actor.world.pos.y, pthis->unk_1B4.y, 0.1f,
                               (pthis->actor.world.pos.y - pthis->unk_1B4.y) * 0.1f);
            }
            ...
            if (((pthis->unk_17A[0] == 1) || (Rand_ZeroOne() < sp11C)) &&
                ((Rand_ZeroOne() < (pthis->unk_1A8 * multiplier)) || ((pthis->unk_150 + 1) == KREG(69)))) {
                if (pthis->unk_150 == 0) {
                    pthis->unk_158 = 3;
                    pthis->unk_190 = 1.2f;
            ...
            if ((D_80B7A694 != 3) || (pthis->unk_17A[2] == 0) ||
                (sqrtf(SQ(pthis->actor.world.pos.x) + SQ(pthis->actor.world.pos.z)) > 800.0f)) {
        ...
        case 4:
            ...
            if ((D_80B7A694 != 3) || (pthis->unk_17A[0] == 0) || (sLurePos.y > (WATER_SURFACE_Y(globalCtx) + 5.0f)) ||
                (sqrtf(SQ(sLurePos.x) + SQ(sLurePos.z)) > 800.0f)) {
        ...
        case 5:
            ...
            if (pthis->actor.world.pos.y < WATER_SURFACE_Y(globalCtx)) {
                ...
                if (pthis->unk_17A[1] > 30) {
                    if (pthis->unk_17A[0] == 0) {
                        ...
                        for (spA2 = 0; spA2 < 100; spA2++) {
                            Matrix_RotateY(Rand_CenteredFloat(3.0f * M_PI / 4.0f) +
                                               (((pthis->actor.yawTowardsPlayer + 0x8000) / 32768.0f) * M_PI),
                                           MTXMODE_NEW);
                            Matrix_MultVec3f(&sp10C, &sp100);
                    ...
                    if (((pthis->unk_17A[1] & 0xF) == 0) && CHECK_BTN_ALL(input->cur.button, BTN_A) &&
                        (!(pthis->unk_1AC >= 60.0f) || (D_80B7E080 >= 2000))) {
            ...
            if ((SQ(sp10C.x) + SQ(sp10C.y) + SQ(sp10C.z)) > SQ(20.0f)) {
                Math_ApproachF(&pthis->actor.world.pos.x, sReelLinePos[LINE_SEG_COUNT - 2].x, 0.2f,
                               2.0f * (pthis->actor.speedXZ * 1.5f));
                Math_ApproachF(&pthis->actor.world.pos.y, sReelLinePos[LINE_SEG_COUNT - 2].y, 0.2f,
                               2.0f * (pthis->actor.speedXZ * 1.5f) * 5.0f * 0.1f);
                Math_ApproachF(&pthis->actor.world.pos.z, sReelLinePos[LINE_SEG_COUNT - 2].z, 0.2f,
                               2.0f * (pthis->actor.speedXZ * 1.5f));
            }
                        ...
                        if ((Message_GetState(&globalCtx->msgCtx) == TEXT_STATE_CHOICE) ||
                            ...
                            if (Message_ShouldAdvance(globalCtx)) {
                                ...
                                if (globalCtx->msgCtx.choiceIndex == 0) {
                                    ...
                                    } else if ((pthis->unk_150 == 0) && (D_80B7E07C == 0) &&
                                               ((s16)pthis->unk_1AC < (s16)D_80B7A670)) {
                                        pthis->unk_1D5 = 1;
    ...
    if (pthis->unk_158 != 6) {
        ...
        if ((pthis->unk_158 != -1) && (pthis->unk_158 != -2) && (pthis->unk_158 != -25)) {
            if ((pthis->actor.world.pos.y > WATER_SURFACE_Y(globalCtx)) &&
                (pthis->actor.prevPos.y <= WATER_SURFACE_Y(globalCtx))) {
                func_80B70A2C(pthis, globalCtx, true);
                func_80B71278(pthis, 1);
                pthis->unk_184 = pthis->actor.velocity.y;
                pthis->actor.velocity.y = 0.0f;
                pthis->unk_16A = Rand_CenteredFloat(32768.0f);
            } else if ((pthis->actor.world.pos.y < WATER_SURFACE_Y(globalCtx)) &&
                       (pthis->actor.prevPos.y >= WATER_SURFACE_Y(globalCtx))) {
        ...
        if ((pthis->actor.world.pos.y < WATER_SURFACE_Y(globalCtx)) &&
            (pthis->actor.world.pos.y > (WATER_SURFACE_Y(globalCtx) - 10.0f)) && ((pthis->unk_15C & 1) == 0) &&
            ...
            if (pthis->actor.bgCheckFlags & 1) {
                if (pthis->actor.world.pos.y > WATER_SURFACE_Y(globalCtx)) {
                    ...
                    if ((pthis->unk_158 == 5) && ((pthis->unk_15C & 1) == 0)) {
                        ...
                        Fishing_SpawnWaterDust(&pthis->actor.projectedPos, (FishingEffect*)globalCtx->specialEffects, &pos,
                                               (pthis->unk_1AC * 0.005f) + 0.15f);
                    }
                }
            }
        }
    ...
    if (pthis->unk_1D2 != 0) {
        ...
        for (i = 0; i < 2; i++) {
            ...
            Fishing_SpawnBubble(&pthis->actor.projectedPos, (FishingEffect*)globalCtx->specialEffects, &pos,
...
void Fishing_DrawFish(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (pthis->unk_150 == 0) {
        ...
        SkelAnime_DrawFlexOpa(globalCtx, pthis->skelAnime.skeleton, pthis->skelAnime.jointTable,
                              pthis->skelAnime.dListCount, Fishing_FishOverrideLimbDraw, Fishing_FishPostLimbDraw, pthis);
    } else {
        ...
        SkelAnime_DrawFlexOpa(globalCtx, pthis->skelAnime.skeleton, pthis->skelAnime.jointTable,
                              pthis->skelAnime.dListCount, Fishing_LoachOverrideLimbDraw, Fishing_LoachPostLimbDraw,
                              pthis);
    }
}
...
void Fishing_DrawOwner(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if ((pthis->actor.projectedPos.z < 1500.0f) &&
        (fabsf(pthis->actor.projectedPos.x) < (100.0f + pthis->actor.projectedPos.z))) {
        gSPSegment(POLY_OPA_DISP++, 0x08, SEGMENTED_TO_VIRTUAL(sFishingOwnerEyeTexs[pthis->unk_160]));

        SkelAnime_DrawFlexOpa(globalCtx, pthis->skelAnime.skeleton, pthis->skelAnime.jointTable,
                              pthis->skelAnime.dListCount, Fishing_OwnerOverrideLimbDraw, Fishing_OwnerPostLimbDraw,
                              pthis);
    }
