...
void func_80905DA8(BossGanon2* pthis, GlobalContext* globalCtx);
    ...
    switch (pthis->unk_39C) {
        case 0:
            ...
            if (Object_IsLoaded(&globalCtx->objectCtx, objectIdx)) {
                ...
                pthis->unk_39C = 1;
                sZelda = (EnZl3*)Actor_SpawnAsChild(&globalCtx->actorCtx, &pthis->actor, globalCtx, ACTOR_EN_ZL3, 970.0f,
        ...
        case 1:
            ...
            if (pthis->unk_398 == 150) {
                Message_StartTextbox(globalCtx, 0x70D3, NULL);
            }
            if (pthis->unk_398 > 250 && Message_GetState(&globalCtx->msgCtx) == TEXT_STATE_NONE) {
                pthis->unk_39C = 2;
                pthis->unk_398 = 0;
        ...
        case 2:
            ...
            if (pthis->unk_398 > 104) {
                Math_ApproachF(&pthis->unk_3B0.y, player->actor.world.pos.y + 47.0f + 7.0f + 15.0f, 0.1f,
                               pthis->unk_410.x);
                Math_ApproachF(&pthis->unk_410.x, 2.0f, 1.0f, 0.1f);
            } else {
                pthis->unk_3B0.y = player->actor.world.pos.y + 47.0f + 7.0f;
            }
            if ((pthis->unk_398 > 170) && (Message_GetState(&globalCtx->msgCtx) == TEXT_STATE_NONE)) {
                pthis->unk_39C = 3;
                pthis->unk_398 = 0;
                pthis->unk_410.x = 0.0f;
            }
        ...
        case 14:
            ...
            break;
        case 15:
            if (((globalCtx->gameplayFrames % 32) == 0) && (pthis->unk_398 < 100)) {
                Audio_PlayActorSound2(&pthis->actor, NA_SE_EN_GANON_BREATH);
            }
            SkelAnime_Update(&pthis->skelAnime);
        ...
        case 22:
            ...
            if (pthis->unk_398 > 166 && pthis->unk_398 < 173) {
                pthis->unk_312 = 2;
            }
            if (pthis->unk_398 > 186 && pthis->unk_398 < 196) {
                pthis->unk_312 = 1;
            }
            if (pthis->unk_398 > 202 && pthis->unk_398 < 210) {
                pthis->unk_312 = 2;
            }
        ...
        case 23:
            SkelAnime_Update(&pthis->skelAnime);
            if (pthis->unk_398 > 222 && pthis->unk_398 < 232) {
                pthis->unk_312 = 2;
            }
...
void func_808FF898(BossGanon2* pthis, GlobalContext* globalCtx) {
    if ((pthis->unk_312 != 0) && (pthis->unk_39E == 0)) {
        ...
        while (actor != NULL) {
            if (actor->id == ACTOR_DEMO_GJ) {
                ...
                if (((actor->params & 0xFF) == 0x10) || ((actor->params & 0xFF) == 0x11) ||
                    ...
                    if (SQ(pthis->unk_218.x - gj->dyna.actor.world.pos.x) +
                            SQ(pthis->unk_218.z - gj->dyna.actor.world.pos.z) <
                        SQ(100.0f)) {
                        s32 pad;
                        Vec3f sp28;
...
s32 func_808FFA24(BossGanon2* pthis, GlobalContext* globalCtx) {
    ...
    while (actor != NULL) {
        if (actor->id == ACTOR_DEMO_GJ) {
            ...
            if (((actor->params & 0xFF) == 0x10) || ((actor->params & 0xFF) == 0x11) ||
                ((actor->params & 0xFF) == 0x16)) {
                if (SQ(pthis->actor.world.pos.x - gj->dyna.actor.world.pos.x) +
                        SQ(pthis->actor.world.pos.z - gj->dyna.actor.world.pos.z) <
                    SQ(200.0f)) {
                    return true;
                }
            }
...
void func_808FFCFC(BossGanon2* pthis, GlobalContext* globalCtx) {
    if (pthis->actor.xzDistToPlayer < 150.0f &&
        ABS((s16)(pthis->actor.yawTowardsPlayer - pthis->actor.shape.rot.y)) < 0x2800) {
        pthis->unk_311 = false;
...
void func_80900650(BossGanon2* pthis, GlobalContext* globalCtx) {
    ...
    if (pthis->unk_311 == 0) {
        if (((pthis->unk_198 - 4.0f) < pthis->skelAnime.curFrame) &&
            (pthis->skelAnime.curFrame < (pthis->unk_198 + 6.0f))) {
            pthis->unk_312 = 1;
        }
    } else if ((((pthis->unk_198 - 4.0f) + 4.0f) < pthis->skelAnime.curFrame) &&
               (pthis->skelAnime.curFrame < (pthis->unk_198 + 6.0f))) {
        pthis->unk_312 = 2;
    }
...
void func_8090120C(BossGanon2* pthis, GlobalContext* globalCtx) {
    ...
    switch (pthis->unk_39C) {
        ...
        case 3:
            ...
            if ((pthis->unk_398 > 80) && (Message_GetState(&globalCtx->msgCtx) == TEXT_STATE_NONE)) {
                pthis->unk_39C = 4;
                pthis->unk_398 = 0;
            }
            break;
        ...
        case 7:
            ...
            if ((pthis->unk_398 >= 34) && (pthis->unk_398 < 40)) {
        ...
        case 75:
            ...
            break;
        case 8:
            if (pthis->unk_398 == 1025) {
                Audio_PlayActorSound2(&pthis->actor, NA_SE_EN_MGANON_STAND);
            }
            if (pthis->unk_398 >= 1000) {
                if (pthis->unk_398 < 1040) {
                    pthis->unk_339 = 23;
                    Math_ApproachZeroF(&globalCtx->envCtx.unk_D8, 1.0f, 0.2f);
                }
            }
            ...
            pthis->unk_3B0.y = pthis->unk_1B8.y;
            pthis->unk_3B0.z = pthis->unk_1B8.z;
            if ((pthis->unk_398 < 1000) && ((pthis->unk_398 % 16) == 0)) {
                Audio_PlayActorSound2(&pthis->actor, NA_SE_EN_MGANON_SWORD);
            }
            if (pthis->unk_398 == 40) {
                pthis->unk_39C = 9;
        ...
        case 10:
            ...
            if ((pthis->unk_398 >= 40) && (pthis->unk_398 <= 110)) {
            ...
            if (pthis->unk_398 > 130) {
                Math_ApproachF(&pthis->unk_3B0.y, (sZelda->actor.world.pos.y + 40.0f + 10.0f) - 20.0f, 0.1f,
                               pthis->unk_410.x);
            } else {
                Math_ApproachF(&pthis->unk_3B0.y, sZelda->actor.world.pos.y + 40.0f + 10.0f, 0.05f,
                               pthis->unk_410.x * 0.25f);
            }
...
void BossGanon2_Update(Actor* thisx, GlobalContext* globalCtx) {
    ...
    if (pthis->unk_344 != 0) {
        ...
        if ((pthis->actionFunc == func_808FFEBC) || (pthis->actionFunc == func_808FFFE0) ||
            (pthis->actionFunc == func_80900104)) {
    ...
    switch (pthis->unk_339) {
        ...
        case 5:
            ...
            globalCtx->envCtx.unk_D8 =
                (Math_SinS(globalCtx->gameplayFrames * 0x5000) * 0.15f) + (0.15f + pthis->unk_33C);
            break;
        case 55:
        ...
        case 6:
            ...
            Math_ApproachF(&pthis->unk_33C, 0.69f, 1.0f, 0.05f);
            globalCtx->envCtx.unk_D8 =
                (Math_SinS(globalCtx->gameplayFrames * 0x7000) * 0.15f) + (0.15f + pthis->unk_33C);
            break;
        case 7:
            globalCtx->envCtx.unk_BE = 0;
            globalCtx->envCtx.unk_BD = 8;
...
void func_80903F38(BossGanon2* pthis, GlobalContext* globalCtx) {
    OPEN_DISPS(globalCtx->state.gfxCtx, "../z_boss_ganon2.c", 5083);

    if (pthis->unk_312 != 0) {
        func_809034E4(&pthis->unk_200, &pthis->unk_20C);
        D_80907080 = 0xFF;
    }
...
void BossGanon2_PostLimbDraw(GlobalContext* globalCtx, s32 limbIndex, Gfx** dList, Vec3s* rot, void* thisx) {
    ...
    if (*dList != NULL) {
        if ((limbIndex == 7) && (pthis->unk_312 == 1)) {
        ...
        } else if ((limbIndex == 13) && (pthis->unk_312 == 2)) {
            Matrix_MultVec3f(&D_809070FC, &pthis->unk_218);
...
void func_80905674(BossGanon2* pthis, GlobalContext* globalCtx) {
    ...
    if (pthis->unk_380 > 0.0f) {
        ...
        gDPPipeSync(POLY_XLU_DISP++);
        gSPSegment(POLY_XLU_DISP++, 0x08,
                   Gfx_TwoTexScroll(globalCtx->state.gfxCtx, 0, pthis->unk_19C * -8, 0, 32, 64, 1, pthis->unk_19C * -4,
                                    pthis->unk_19C * -8, 32, 32));
...
void BossGanon2_Draw(Actor* thisx, GlobalContext* globalCtx) {
    ...
    switch (pthis->unk_337) {
        ...
        case 2:
            ...
            gSPMatrix(POLY_OPA_DISP++, Matrix_NewMtx(globalCtx->state.gfxCtx, "../z_boss_ganon2.c", 5910),
                      G_MTX_NOPUSH | G_MTX_LOAD | G_MTX_MODELVIEW);
            SkelAnime_DrawFlexOpa(globalCtx, pthis->skelAnime.skeleton, pthis->skelAnime.jointTable,
                                  pthis->skelAnime.dListCount, BossGanon2_OverrideLimbDraw, BossGanon2_PostLimbDraw,
                                  pthis);
    ...
    if ((pthis->unk_312 != 0) || (D_80907080 != 0)) {
        func_80903F38(pthis, globalCtx);
        if (pthis->unk_312 == 0) {
            s32 pad;
