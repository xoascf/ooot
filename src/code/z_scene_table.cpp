...
void func_80099878(GlobalContext* globalCtx) {
    u32 gameplayFrames;
    s32 pad;
    Gfx* displayListHead = (Gfx*)Graph_Alloc(globalCtx->state.gfxCtx, 2 * sizeof(Gfx[3]));
...
void func_80099BD8(GlobalContext* globalCtx) {
    f32 temp;
    Gfx* displayListHead = (Gfx*)Graph_Alloc(globalCtx->state.gfxCtx, 18 * sizeof(Gfx));
...
void func_8009DA30(GlobalContext* globalCtx) {
    ...
    displayListHead = (Gfx*)Graph_Alloc(globalCtx->state.gfxCtx, 3 * sizeof(Gfx));
...
void func_8009E0B8(GlobalContext* globalCtx) {
    ...
    spA3 = 128;
    spA0 = 500;
    displayListHead = (Gfx*)Graph_Alloc(globalCtx->state.gfxCtx, 6 * sizeof(Gfx));
...
void func_8009F5D4(GlobalContext* globalCtx) {
    Gfx* displayListHead = (Gfx*)Graph_Alloc(globalCtx->state.gfxCtx, 3 * sizeof(Gfx));
