...
const char* D_8012CEE0[] = { GFXP_KATAKANA "ｷ-ﾌﾚ-ﾑ" GFXP_HIRAGANA "ｶﾞ" };
const char* D_8012CEE4	 = GFXP_HIRAGANA "ﾀﾘﾏｾﾝ｡";
const char* D_8012CEE8	 = GFXP_HIRAGANA "ｻｲｾｲﾃﾞｷﾏｾﾝ";
const char* D_8012CEEC	 = GFXP_HIRAGANA "ｻｲｾｲｼｭｳﾘｮｳ";
const char* D_8012CEF0	 = GFXP_HIRAGANA "ｻｲｾｲﾁｭｳ!";

const char* D_8012CEF4 = "DEMO CAMERA TOOL";
const char* D_8012CEF8[] = {GFXP_HIRAGANA "ﾓｳﾊｲﾘﾏｾﾝ", GFXP_HIRAGANA "ﾄｳﾛｸ   ﾃﾝﾒ", GFXP_HIRAGANA "ﾍﾝｺｳ   /  "};
const char* D_8012CF04	 = ">            >";
const char* D_8012CF08	 = "<            <";
const char* D_8012CF0C	 = "<          >";
const char* D_8012CF10	 = GFXP_KATAKANA "*ﾌﾟﾚｲﾔ-*";
const char* D_8012CF14	 = GFXP_KATAKANA "Eﾓ-ﾄﾞ" GFXP_HIRAGANA " ｿｳﾀｲ";
const char* D_8012CF18[] = {GFXP_KATAKANA "Eﾓ-ﾄﾞ" GFXP_HIRAGANA "ｾﾞｯﾀｲ", GFXP_HIRAGANA "ｶﾞﾒﾝ" GFXP_KATAKANA "   ﾃﾞﾓ",
                       GFXP_HIRAGANA "ｶﾞﾒﾝ   ﾌﾂｳ" };
const char* D_8012CF24[] = {GFXP_HIRAGANA "Pｼﾞｶﾝ  MAX", GFXP_KATAKANA "ﾘﾝｸ" GFXP_HIRAGANA "    ｷｵｸ",
                       GFXP_KATAKANA "ﾘﾝｸ" GFXP_HIRAGANA "     ﾑｼ" };
const char* D_8012CF30 = GFXP_HIRAGANA "*ﾐﾃﾙｲﾁ*";
const char* D_8012CF34 = GFXP_KATAKANA "*ｶﾒﾗ" GFXP_HIRAGANA "ｲﾁ*";
const char* D_8012CF38 = "DEBUG CAMERA";
const char* D_8012CF3C = GFXP_KATAKANA "ｾﾝﾀ-/ﾛｯｸ";
const char* D_8012CF40 = GFXP_KATAKANA "ｾﾝﾀ-/ﾌﾘ-";

const char* D_8012CF44 = "DEMO CONTROL";
const char* D_8012CF48 = GFXP_KATAKANA "ﾒﾓﾘ" GFXP_HIRAGANA "ｶﾞﾀﾘﾏｾﾝ";
const char* D_8012CF4C = "p";
const char* D_8012CF50[] = { "e", "s", "l", "c" };

const char* D_8012CF60[] = { GFXP_KATAKANA "ﾒﾓﾘﾊﾟｯｸ" }; // "Mempak"
const char* D_8012CF64 = GFXP_KATAKANA "ｾｰﾌﾞ";          // "Save"
const char* D_8012CF68 = GFXP_KATAKANA "ﾛｰﾄﾞ";          // "Load"
const char* D_8012CF6C = GFXP_KATAKANA "ｸﾘｱ-";          // "Clear"
const char* D_8012CF70 = GFXP_HIRAGANA "ｦﾇｶﾅｲﾃﾞﾈ";

const char* D_8012CF74 = "FREE      BYTE";
const char* D_8012CF78 = "NEED      BYTE";
const char* D_8012CF7C = GFXP_KATAKANA "*ﾒﾓﾘ-ﾊﾟｯｸ*";
const char* D_8012CF80 = GFXP_HIRAGANA "ｦﾐﾂｹﾗﾚﾏｾﾝ";
const char* D_8012CF84 = GFXP_KATAKANA "ﾌｧｲﾙ " GFXP_HIRAGANA "ｦ";
const char* D_8012CF88[] = { GFXP_HIRAGANA "ｼﾃﾓｲｲﾃﾞｽｶ?", GFXP_HIRAGANA "ｹﾞﾝｻﾞｲﾍﾝｼｭｳﾁｭｳﾉ",
                       GFXP_KATAKANA "ﾌｧｲﾙ" GFXP_HIRAGANA "ﾊﾊｷｻﾚﾏｽ" };
const char* D_8012CF94 = GFXP_HIRAGANA "ﾊｲ";
const char* D_8012CF98 = GFXP_HIRAGANA "ｲｲｴ";
const char* D_8012CF9C[] = { GFXP_HIRAGANA "ｼﾃｲﾏｽ", GFXP_HIRAGANA "ｳﾜｶﾞｷ" };
const char* D_8012CFA4 = GFXP_HIRAGANA "ｼﾏｼﾀ";
const char* D_8012CFA8 = "USE       BYTE";
const char* D_8012CFAC = GFXP_HIRAGANA "ﾆｼｯﾊﾟｲ";

const char* D_8012CFB0 = GFXP_KATAKANA "Eﾓ-ﾄﾞ" GFXP_HIRAGANA "  ｺﾃｲ";
...
void func_800B44E0(DbCamera* dbCamera, Camera* cam) {
    ...
    if (!func_800BB2B4(&sDbCamAnim.positionPos, &sDbCamAnim.roll, &sDbCamAnim.fov, dbCamera->sub.position,
        ...
        sDbCamAnim.strengthList++;

        if (dbCamera->sub.nFrames > 0 && dbCamera->sub.nFrames < sDbCamAnim.strengthList) {
            sDbCamAnim.unk_0A = 0;
        ...
        DbCamera_SetTextValue(sDbCamAnim.strengthList, &D_8012CFB4[8], 4);
...
void DbCamera_Update(DbCamera* dbCamera, Camera* cam) {
    ...
    *sp90 = temp_s6->pos;
    ...
    if (dbCamera->lengthList > 100) {
        dbCamera->lengthList = 100;
    }

    new_var2 = ((dbCamera->lengthList * 0.15f) + 0.2f);
...
char DbCamera_InitCut(s32 idx, DbCameraSub* sub) {
    ...
    sDbCameraCuts[idx].lookAt = (CutsceneCameraPoint*)DebugArena_MallocDebug(i, "../db_camera.c", 2748);
    ...
    sDbCameraCuts[idx].position = (CutsceneCameraPoint*)DebugArena_MallocDebug(i, "../db_camera.c", 2754);
...
s32 DbCamera_LoadCallback(char* c) {
    ...
    for (i = 0; i < ARRAY_COUNT(sDbCameraCuts) - 1; i++) {
        if (sDbCameraCuts[i].letter != '?') {
            ...
            sDbCameraCuts[i].lookAt = (CutsceneCameraPoint*)DebugArena_MallocDebug(ALIGN32(size), "../db_camera.c", 2844);
            ...
            sDbCameraCuts[i].position = (CutsceneCameraPoint*)DebugArena_MallocDebug(ALIGN32(size), "../db_camera.c", 2855);
...
s32 func_800B91B0(Camera* cam, DbCamera* dbCamera) {
    ...
    if (!func_800BB2B4(&sDbCamAnim.positionPos, &sDbCamAnim.roll, &sDbCamAnim.fov, sDbCameraCuts[D_8016110C].position,
        ...
        DbCamera_SetTextValue(sDbCamAnim.strengthList, &D_8012D114[10], 4);
        ...
        if (sDbCameraCuts[D_8016110C].nFrames > 0 && sDbCameraCuts[D_8016110C].nFrames < sDbCamAnim.strengthList) {
            D_8016110C++;
            sDbCamAnim.curFrame = 0.0f;
            sDbCamAnim.strengthList = 0;
            sDbCamAnim.keyframe = 0;
        ...
        case ACTION_CLEAR:
            switch (dbCamera->sub.demoCtrlMenu) {
                ...
                case DEMO_CTRL_MENU(ACTION_CLEAR, MENU_CALLBACK): {
                    ...
                    if (callbacks[dbCamera->sub.demoCtrlActionIdx - 1]((char*)&D_8012CF84[9])) {
                        dbCamera->sub.demoCtrlMenu++;
                        return 1;
                    } else {
